...
var storyText="It was 94 fahrenheit outside, so :insertx: went for a walk. When they got to :inserty:, they stared straight ahead for a few moments, then :insertz:. Star, a :insertp:, saw the whole thing, but wasn't surprised — they looked away and then jumped into a :inserts: as it was a hot day.";
var insertS=["a pool of tomatoes","a river of iceballs","a turquoise ocean full of marbles","a giant seashell","dormant volcano","time travel machine","puddle","ice cream tub","bottle of sparkling water"];
...
var insertZ = ["spontaneously combusted","melted into a puddle on the sidewalk","splattered paint all over a young dinosaur","started bouncing on a trampoline","started jugging 10 kittens at once","doodled something on a sleeping policeman and galloped away","started sqeaking in a hummingbird's voice","drank a soda and started to breathe bubbles","took a candy out of a pocket, ate it and started to change colours","started shouting about a snowman who came alive","went to a barber to look like a grapefruit","ate a pizza and started to levitate","glued a sparkly hat to one hand","floated away in a giant plastic duck","took a nap on a toffee","went to a tattoo shop to tattoo bubbles all over themselves","told everyone about a movie where they were the villain even though they are not an actor","sent a random text to the college principal in alien code","ate a candy and turned into a giant cockroach", "turned into a slug and crawled away"];
