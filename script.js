...
var storyText="It was 94 fahrenheit outside, so :insertx: went for a walk. When they got to :inserty:, they stared straight ahead for a few moments, then :insertz:. Star, a :insertp:, saw the whole thing, but wasn't surprised — they looked away and then :insertk: into a :inserts: as it was a hot day.";
...
var insertK = ["jumped straight","bounced high", "danced wildly", "sprinted quickly", "skipped merrily", "hopped joyfully", "leaped gracefully", "ran swiftly", "jumped energetically", "dashed madly", "galloped wildly", "vaulted effortlessly", "hurdled gracefully", "climbed nimbly", "swung freely", "spun around", "twirled gracefully", "cartwheeled joyfully", "flipped acrobatically", "tumbled playfully", "rolled around", "slid smoothly", "skated gracefully", "glided effortlessly", "sailed smoothly", "soared majestically", "flew high"
];
...
var xItem, yItem, zItem, pItem,sItem,kItem;
...
kItem = randomValueFromArray(insertK);
